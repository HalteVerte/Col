...
// Style MapLibre partagé (fond clair Protomaps-like)
function mlStyle() {
  return {
    version: 8,
    ...
    layers: [
      ...
      { id:'roads',   type:'line', source:'basemap', 'source-layer':'roads',
        paint:{'line-color':'#c8b89a','line-width':['interpolate',['linear'],['zoom'],4,0.4,12,2.5]} },
      { id:'labels',  type:'symbol', source:'basemap', 'source-layer':'places',
        layout:{'text-field':['get','name:fr'],'text-size':['interpolate',['linear'],['zoom'],4,8,12,13],'text-font':['Noto Sans Regular']},
        paint:{'text-color':'#3a2a1a','text-halo-color':'rgba(255,255,255,.8)','text-halo-width':1} }
    ]
  };
}
