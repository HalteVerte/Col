...
window.TRAJET_RETOUR = {
  ...
  phases: [
    ...
    --------------------------------------------- */
    {
      ...
      etapes: [
        { nom: 'Lagos — Ria de Alvor (DÉPART)', lat: 37.099, lng: -8.673, type: 'depart', km: 0,
    ...
    --------------------------------------------- */
    {
      ...
      etapes: [
        ...
        { nom: 'Bilbao — Ría del Nervión', lat: 43.263, lng: -2.935, type: 'halte', km: 530,
    ...
    --------------------------------------------- */
    {
      ...
      etapes: [
        { nom: 'Hendaye — Retour France', lat: 43.355, lng: -1.774, type: 'halte', km: 0,
        ...
        { nom: 'Bayonne — Adour', lat: 43.493, lng: -1.473, type: 'cueillette', km: 40,
        ...
        { nom: 'Bordeaux — Garonne', lat: 44.837, lng: -0.58, type: 'halte', km: 270,
    ...
    --------------------------------------------- */
    {
      ...
      etapes: [
        ...
        { nom: 'La Rochelle — Pertuis charentais', lat: 46.16, lng: -1.151, type: 'halte', km: 50,
        ...
        { nom: 'Nantes — Loire', lat: 47.218, lng: -1.554, type: 'halte', km: 280,
    ...
    --------------------------------------------- */
    {
      ...
      etapes: [
        { nom: 'Quiberon — Presqu\'île', lat: 47.484, lng: -3.119, type: 'cueillette', km: 120,
        ...
        { nom: 'Lorient — Ria d\'Étel', lat: 47.748, lng: -3.367, type: 'cueillette', km: 170,
        ...
        { nom: 'Brest — Rade', lat: 48.39, lng: -4.486, type: 'halte', km: 360,
        ...
        { nom: 'Saint-Malo — Rance', lat: 48.649, lng: -2.025, type: 'halte', km: 500,
    ...
    --------------------------------------------- */
    {
      ...
      etapes: [
        ...
        { nom: 'Cherbourg — Cap de la Hague', lat: 49.634, lng: -1.622, type: 'cueillette', km: 160,
        ...
        { nom: 'Dieppe — Côte d\'Albâtre', lat: 49.922, lng: 1.075, type: 'cueillette', km: 260,
        ...
        { nom: 'Abbeville — Vallée de la Somme', lat: 50.106, lng: 1.833, type: 'bivouac', km: 360,
        ...
        { nom: 'Artemps — RETOUR 🏁', lat: 49.65, lng: 3.27, type: 'arrivee', km: 400,
...
/* Points de passage Retour — pour détection position 6BL */
window.TRAJET_RETOUR_WAYPOINTS = [
  { nom: 'Portimão', lat: 37.1359, lng: -8.5369 },
  { nom: 'Sagres', lat: 36.994, lng: -8.942 },
  { nom: 'Faro', lat: 37.019, lng: -7.93 },
  { nom: 'Huelva', lat: 37.261, lng: -6.944 },
  { nom: 'Séville', lat: 37.389, lng: -5.984 },
  { nom: 'Badajoz', lat: 38.8794, lng: -6.9706 },
  { nom: 'Cáceres', lat: 39.4752, lng: -6.3724 },
  { nom: 'Salamanque', lat: 40.965, lng: -5.664 },
  { nom: 'Saint-Jacques', lat: 42.8782, lng: -8.5448 },
  { nom: 'Vigo', lat: 42.24, lng: -8.72 },
  { nom: 'Bayonne', lat: 43.493, lng: -1.473 },
  { nom: 'Bordeaux', lat: 44.837, lng: -0.58 },
  { nom: 'La Rochelle', lat: 46.16, lng: -1.151 },
  { nom: 'Nantes', lat: 47.218, lng: -1.554 },
  { nom: 'Saint-Malo', lat: 48.649, lng: -2.025 },
  { nom: 'Cherbourg', lat: 49.634, lng: -1.622 },
  { nom: 'Caen', lat: 49.183, lng: -0.351 },
  { nom: 'Rouen', lat: 49.443, lng: 1.099 },
  { nom: 'Amiens', lat: 49.8942, lng: 2.2957 },
  { nom: 'Artemps', lat: 49.65, lng: 3.27 }
];
